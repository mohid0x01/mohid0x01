...
<img align="right" width="38%" src="https://github-readme-stats.vercel.app/api?username=mohid0x01&show_icons=true&theme=chartreuse-dark&bg_color=0d1117&hide_border=true&title_color=00ff41&icon_color=00ff41&text_color=c9d1d9&custom_title=mohid0x01%20Stats" />
...
Teams   : TeamCyberOps | HackerOne | Bugcrowd
Base    : Sindh, Pakistan 🇵🇰
Focus   : Web AppSec · Recon Automation · Red Team
```

- 🐛 Active researcher on **HackerOne** & **Bugcrowd** — `@cyberops_r00t`
- 🔍 Specialise in **XSS chains · IDOR · SSRF · Broken Auth · API flaws**
- 🛠 Building custom offensive security tools under **[@mohidqx](https://github.com/mohidqx)**
- 🏴 Completed **30 Days, 30 CTFs** Challenge — Web / Crypto / Forensics
- 🎓 Certified: **CEH · CISSP** — IBA Best Cybersecurity Performance Award
- 📬 Reach me: **mohid.qx@proton.me**
...
|:---:|:---:|:---:|
| ![HackerOne](https://img.shields.io/badge/HackerOne-black?style=flat-square&logo=hackerone&logoColor=FF6600) | [@cyberops-root](https://hackerone.com/cyberops-root?type=user) | Web Apps · API · Auth |
| ![Bugcrowd](https://img.shields.io/badge/Bugcrowd-black?style=flat-square&logo=bugcrowd&logoColor=F26722) | [@cyberops_r00t](https://bugcrowd.com/h/cyberops_r00t) | IDOR · Access Control · Info Disclosure |

</div>

> **Critical/High** findings: XSS chains, IDOR, Broken Access Controls, Information Disclosure
...
![Nmap](https://img.shields.io/badge/Nmap-black?style=for-the-badge&logo=nmap&logoColor=00ff41)
![Shodan](https://img.shields.io/badge/Shodan-black?style=for-the-badge&logo=shodan&logoColor=FF0000)
...
![Burp Suite](https://img.shields.io/badge/Burp_Suite_Pro-black?style=for-the-badge&logo=burpsuite&logoColor=FF6633)
...
## 📦 Projects — [@mohidqx](https://github.com/mohidqx) (Org)

> All offensive tooling, CTF platforms, and research lives under **TeamCyberOps**

### 🔴 Offensive Security & Research

| Project | Description | Stars |
|---|---|:---:|
| [**TeamCyberOps-Recon**](https://github.com/mohidqx/TeamCyberOps-Recon) `HTML` | Browser-based recon engine — multi-stage intelligence gathering, WAF detection & vuln scanning via dark-ops interface | — |
| [**AutoInjectX**](https://github.com/mohidqx/AutoInjectX) `Python` | XSS automation — reflected, stored, DOM-based. Multi-threading + false-positive reduction | ⭐ 1 |
| [**Recon-Subdomain**](https://github.com/mohidqx/Recon-Subdomain) `Python` | Single-file recon orchestrator — subdomain enum, live probing, port scan. **60% faster** per-target | ⭐ 1 |
| [**NucleiFuzzer**](https://github.com/mohidqx/NucleiFuzzer) `Shell` | Advanced Nuclei-based fuzzing framework for large scope automation | — |
| [**VulnScopeX**](https://github.com/mohidqx/VulnScopeX) `Python` | Vulnerability scope management engine v6.0 with roadmap integration for bounty workflows | — |
...
| [**GhostSession**](https://github.com/mohidqx/GhostSession) `JavaScript` | Browser extension demonstrating session hijacking risks & cookie handling vulns | ⭐ 1 |
| [**uncover**](https://github.com/mohidqx/uncover) `Go` | Fork of ProjectDiscovery's uncover — exposed host discovery via Shodan, Censys, FOFA, Hunter | — |

### 🚩 CTF Platforms

| Project | Description |
|---|---|
| [**CTF**](https://github.com/mohidqx/CTF) `HTML` | Web challenges focused on real-world vulns — XSS, SQLi, IDOR, Logic Flaws |
...
| [**asma-portfolio**](https://github.com/mohidqx/asma-portfolio) `Next.js` | Freelance client portfolio — performance-first architecture with SEO |
| [**AI-Chatbot**](https://github.com/mohidqx/AI-Chatbot) `TypeScript` | LLM-powered chatbot with modern responsive UI |
| **Copy-Trading-Platform** `TypeScript` | Real-time financial dashboard with data visualisation |

### 🤖 Automation & Bots

| Project | Stars |
|---|:---:|
| [**SAKAMOTO-MD**](https://github.com/mohidqx/SAKAMOTO-MD) — Modular Node.js WhatsApp multi-device bot | ⑃ 37 forks |
| [**TwitterPro**](https://github.com/mohidqx/TwitterPro) — X automation browser extension | — |
...
<img width="49%" src="https://github-readme-stats.vercel.app/api?username=mohid0x01&show_icons=true&theme=chartreuse-dark&bg_color=0d1117&hide_border=true&title_color=00ff41&icon_color=00ff41&text_color=c9d1d9" />
<img width="49%" src="https://github-readme-stats.vercel.app/api?username=mohidqx&show_icons=true&theme=chartreuse-dark&bg_color=0d1117&hide_border=true&title_color=00ff41&icon_color=00ff41&text_color=c9d1d9&custom_title=mohidqx%20(Org)%20Stats" />

<img width="49%" src="https://streak-stats.demolab.com?user=mohid0x01&theme=dark&bg_color=0d1117&hide_border=true&ring=00ff41&fire=00ff41&currStreakLabel=00ff41" />
<img width="49%" src="https://github-readme-stats.vercel.app/api/top-langs/?username=mohid0x01&layout=compact&theme=chartreuse-dark&bg_color=0d1117&hide_border=true&title_color=00ff41" />
...
[★] Best Cybersecurity Performance — IBA University Incubation Center
[🚩] 30 Days 30 CTFs Challenge — Web / Crypto / Forensics (Full Write-ups)
[🐛] Active Bug Bounty Researcher — Critical/High severity findings
```
